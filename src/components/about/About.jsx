        ...
        <div className={styles.aboutContent}>
          ...
          <div className={styles.textWrapper}>
            ...
            <p className={styles.description}>
              ...
              one of the best cab service in Krishnagiri, provides its services
              between various locations across Tamilnadu at best price. We
              provides safest journey in Tamil Nadu
            </p>
            <ul className={styles.features}>
              <li>
                <strong>Best Drivers</strong>
                <p>
                  We have drivers with more than 15 years of experience in this
                  driving field . so that we ensure customers to have pleasant
                  journey.
                </p>
              </li>
              <li>
